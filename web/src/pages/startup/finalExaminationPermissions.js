...
const CODE_STUDENT = 'flow.final_examination.student';
const CODE_SCHOOL = 'flow.final_examination.school';
const CODE_GRADUATE_SCHOOL = 'flow.final_examination.graduate_school';
